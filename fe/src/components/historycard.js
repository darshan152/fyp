...
import { setAdd, setAggregate, setPython, setRead, setWrite, setJoin, setScale, setMissing, setDelete, setFilter, setEncode, setDatatype, setRename } from '../states/cardModalSlice';
